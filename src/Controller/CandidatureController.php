...
class CandidatureController extends BaseController
{
    ...
    {
        $this->requirePermission('candidature.submit');
    ...
    public function submit(): void
    {
        ...
        $cvPath = $this->handleCvUpload($offre, $lm, $message);
        if ($cvPath === false) {
            return;
        }
        ...
        Database::getInstance()->query(
            'CALL sp_apply(?, ?, ?, ?, ?)',
            [Auth::id(), $offreId, $cvPath, $lm, $message]
        );
    ...
    private function handleCvUpload(array $offre, string $lm, string $message): string|null|false
    {
